...
<body>
    <?php
    $connect = mysqli_connect('localhost', 'sio2', 'Sio2assword$', 'log_db') or die("connect failed");
    $number = $_GET['number'];
            ...
            <table style="padding-top:50px" align=center width=auto border=0 cellpadding=2>
                <tr>
                    <td style="height:30; float:center; background-color: cornflower">
                        <p style="font-size: 20px; text-align:center; color:white; margin-top:15px; margin-bottom:15px"><b>게시글 수정하기</b></p>
                    </td>
                </tr>
                <tr>
                    <td>
